...
\nohyphens{
	\begin{tabular}{| p{3.5cm} | p{3.5cm} | c | c | c | c |}
		...
		\multicolumn{5}{|l|}{Итого затраты на основную заработную плату
		разработчиков}
		& \num{\costTotal}
		\\ \hline
	\end{tabular}
...
Экономический эффект измеряется разностью между денежным доходом от деятельности
и денежным расходам на осуществление деятельности.
